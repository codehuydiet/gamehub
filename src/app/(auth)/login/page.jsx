            ...
            <div className={style.contentContainer}>
                ...
                <div className="flex justify-center w-[100] mt-[0.5rem] flex-col">
                    <form action={handleGooglLogin}>
                        <button type="button" aria-label="Login with Google" className="w-[23.5rem] h-[3.5rem] block bg-[#ffffff] flex items-center justify-center rounded-[1.25rem]">
                    ...
                    <form action={handleGithubLogin}>
                        <button type="button" aria-label="Login with GitHub" className="w-[23.5rem] h-[3.5rem] mr-[0.5rem] block bg-[#28293d] flex items-center justify-center rounded-[1.25rem] mt-[0.75rem]">
